  ...
  return (
    <div className={s.big_slider__slider_wrapper}>
      ...
      <div className={s.big_slider__slider_content}>
                ...
                >
                  {renderContent ? (
                    ...
                    <>
                      ...
                      <p className={s.big_slider__slide_desc}>{slide.desc}</p>
                    </>
                  )}
                </motion.div>
              )
        ...
        {controls && device !== "tablet" && (
          <div className={s.big_slider__slider_controls}>
            <button
              id={s.big_slider__slider_left}
              className={s.big_slider__slider_control}
              onClick={() => {
                slider.current.slidePrev();
              }}
            >
              <svg
                className={s.big_slider__slider_control_icon}
                viewBox="0 0 20 18"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            <div className={s.big_slider__slider_pagination_wrapper}>
              {slides.map((slide, index) => (
                <button
                  onClick={() => {
                    slider.current.slideTo(index);
                  }}
                  className={`${s.big_slider__slider_pagination} ${
